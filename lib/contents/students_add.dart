...
class _AddStudentPageState extends State<AddStudentPage> {
  ...
  final rollCtrl = TextEditingController(); // optional
  ...
  Future<void> addStudent() async {
    ...
    final student = StudentModel(
      ...
      academic: AcademicModel(
        ...
        rollNo: rollCtrl.text.isEmpty
            ? null
            : int.tryParse(rollCtrl.text),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _field(contactCtrl, 'Contact', Icons.phone,
                      isNumber: true),
                  ...
                  Row(
                    children: [
                      ...
                      //     activeColor: AppColors.greenishTeal,
                  ...
                  _field(passwordCtrl, 'Password', Icons.lock,
                      obscure: true),
